    ...
    <div class="article-admin">
                ...
                <b-col xs="12">
                    ...
                    <b-form-group  v-if="mode === 'save'" 
                        ...
                        <VueEditor  v-model="article.content"
                            placeholder="Informe o Conteúdo do arquivo..." />
                    </b-form-group>
                </b-col>
                <b-col xs="12">
       ...
       <b-table hover striped :items="articles" :fields="fields">
           <template slot="actions" slot-scope="data">
               <b-button variant="warning" v-on:click="loadArticle(data.item)" class="mr-2">
                   <i class="fa fa-pencil"></i>
               </b-button>
               <b-button variant="danger" v-on:click="loadArticle(data.item, 'remove')">
        ...
        loadUsers() {
            ...
            axios.get(url).then(res => {
                this.users = res.data.map(user => {
                    return { value: user.id, text:`${user.id}-${user.email}`}
                })
            })
        }
    }, 
